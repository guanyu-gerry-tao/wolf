...
- 7 - **Cover letter writer** (parallel branch 2b) — Claude consumes pool + JD + profile + brief, returns an HTML body, which wolf writes to `data/jobs/<dir>/src/cover_letter.html`.
